...
His vertical speed is forced to 0 → he’s not moving up or down.
His vertical acceleration is reset → no jump or extra forces.
 This prevents him from sinking into the ground or continuing downward.*/
